...
- [https://github.com/file-tools](https://github.com/file-tools) - plain text files tools - compression, file dates, parsing
- [https://github.com/surgo-git](https://github.com/surgo-git) - git and github related notes and tools for sync
